...
import { useDispatch, useSelector } from "react-redux"; import SideBarSkeleton from "./skeletons/SideBarSkeleton";
            ...
            <div className="overflow-y-auto w-full py-3">
                {filteredUsers?.length > 0 && filteredUsers.map((user) => {
                    return(<button
                        ...
                        className={`w-full p-3 flex items-center gap-3 transition-colors rounded-md ${selectedUser?._id === user._id ? "bg-gray-200 ring-gray-200" :
                            "hover:bg-gray-200"}`}
                    >
                        {/* AVATAR */}
