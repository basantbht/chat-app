                ...
                <div className="flex items-center gap-3">
                    {
                        authUser && (
                            <>
                            <Link to={"/profile"}
                            className="inline-flex items-center gap-2 px-3 py1.5
                             rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100 transition"
                            >
                            ...
                            className="inline-flex items-center gap-2 px-3 py1.5
                             rounded-md text-sm font-medium text-red-700 hover:bg-red-100 transition"
                            >
