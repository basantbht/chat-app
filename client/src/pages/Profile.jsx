      ...
      <div className="bg-white rounded-xl shadow-md p-6 space-y-8">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            <img src={
              selectedImage || formData.avatar || "/avatar.jpg"}
              alt="/avatar.jpg"
        ...
        <button onClick={handleUpdateProfile} disabled={isUpdatingProfile} className="w-full bg-blue-500 hover:bg-blue-700 text-white font-medium py-2 rounded-md transition duration-200 flex justify-center items-center gap-2">
          {
            isUpdatingProfile ? (
              <>
